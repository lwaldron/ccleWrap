...
syms = unlist(mget(tte[,1], hgu133plus2hsentrezgSYMBOL))
tte = cbind(tte, syms)
tte
@
...
ieplot(exMEKo, ttglob[1,1], main="main effect", legx=8.5, legy=.7)
ieplot(exMEKo, ttact[1,1], main="adj. org./int", noleg=TRUE)
ieplot(exMEKo, ttorg[1,1], main="organ (F test)", noleg=TRUE)
ieplot(exMEKo, ttinter[1,1], main="interaction (F test)", noleg=TRUE)
@
\end{center}
